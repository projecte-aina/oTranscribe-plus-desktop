...
function init() {
  ...
  (0,_texteditor__WEBPACK_IMPORTED_MODULE_0__.watchFormatting)();
  ...
  (0,_texteditor__WEBPACK_IMPORTED_MODULE_0__.initAutoscroll)(); // this is necessary due to execCommand restrictions
  ...
  otrQueryParams = (0,_input__WEBPACK_IMPORTED_MODULE_1__.getQueryParams)(); // If the ?v=<VIDEO_ID> parameter is found in the URL, auto load YouTube video

  if (otrQueryParams['v']) {
    $('.start').removeClass('ready');
    (0,_player_player__WEBPACK_IMPORTED_MODULE_4__.createPlayer)({
      driver: _player_player__WEBPACK_IMPORTED_MODULE_4__.playerDrivers.YOUTUBE,
      source: "https://www.youtube.com/watch?v=" + otrQueryParams.v
    }).then(function (player) {
      (0,_input__WEBPACK_IMPORTED_MODULE_1__.hide)();
      _view_controller__WEBPACK_IMPORTED_MODULE_10__["default"].set('editor');
      (0,_ui__WEBPACK_IMPORTED_MODULE_5__.bindPlayerToUI)();
      var timestamp = otrQueryParams['t'];

      if (timestamp) {
        // Is the timestamp in HH:MM::SS format?
        if (~timestamp.indexOf(":")) {
          timestamp = (0,_timestamps__WEBPACK_IMPORTED_MODULE_6__.convertTimestampToSeconds)(timestamp);
        }
  ...
  $('.title').mousedown(function () {
    if (_view_controller__WEBPACK_IMPORTED_MODULE_10__["default"].is('about')) {
      _view_controller__WEBPACK_IMPORTED_MODULE_10__["default"].set('editor');
    } else {
      _view_controller__WEBPACK_IMPORTED_MODULE_10__["default"].set('about');
    }
  });
...
function onLocalized() {
  var resetInput = (0,_input__WEBPACK_IMPORTED_MODULE_1__.inputSetup)({
    create: function create(file) {
      var driver = (0,_player_player__WEBPACK_IMPORTED_MODULE_4__.isVideoFormat)(file) ? _player_player__WEBPACK_IMPORTED_MODULE_4__.playerDrivers.HTML5_VIDEO : _player_player__WEBPACK_IMPORTED_MODULE_4__.playerDrivers.HTML5_AUDIO;
      (0,_player_player__WEBPACK_IMPORTED_MODULE_4__.createPlayer)({
        driver: driver,
        source: window.URL.createObjectURL(file),
        name: file.name
      }).then(function () {
        (0,_ui__WEBPACK_IMPORTED_MODULE_5__.bindPlayerToUI)(file.name);
      });
    },
    createFromURL: function createFromURL(url) {
      (0,_player_player__WEBPACK_IMPORTED_MODULE_4__.createPlayer)({
        driver: _player_player__WEBPACK_IMPORTED_MODULE_4__.playerDrivers.YOUTUBE,
        source: url
      }).then(function () {
  ...
  (0,_texteditor__WEBPACK_IMPORTED_MODULE_0__.watchWordCount)();
  ...
  $('.reset').off().on('click', function () {
    var player = (0,_player_player__WEBPACK_IMPORTED_MODULE_4__.getPlayer)();
    resetInput();
  ...
  (0,_old_browsers__WEBPACK_IMPORTED_MODULE_2__["default"])(); // oT.input.loadPreviousFileDetails();
}
...
/* harmony export */ });
/* harmony import */ var _clean_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
...
const htmlparser = __webpack_require__(7);
const escapeStringRegexp = __webpack_require__(32);
const { isPlainObject } = __webpack_require__(33);
const deepmerge = __webpack_require__(34);
const parseSrcset = __webpack_require__(35);
const { parse: postcssParse } = __webpack_require__(36);
...
var domhandler_1 = __webpack_require__(15);
...
var Tokenizer_1 = __webpack_require__(9);
Object.defineProperty(exports, "Tokenizer", ({ enumerable: true, get: function () { return __importDefault(Tokenizer_1).default; } }));
var ElementType = __importStar(__webpack_require__(16));
...
exports.DomUtils = __importStar(__webpack_require__(19));
var FeedHandler_1 = __webpack_require__(18);
...
var Tokenizer_1 = __importDefault(__webpack_require__(9));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var decode_codepoint_1 = __importDefault(__webpack_require__(10));
var entities_json_1 = __importDefault(__webpack_require__(12));
var legacy_json_1 = __importDefault(__webpack_require__(13));
var xml_json_1 = __importDefault(__webpack_require__(14));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var decode_json_1 = __importDefault(__webpack_require__(11));
...
var domelementtype_1 = __webpack_require__(16);
...
var domhandler_1 = __importDefault(__webpack_require__(15));
var DomUtils = __importStar(__webpack_require__(19));
var Parser_1 = __webpack_require__(8);
...
var domhandler_1 = __webpack_require__(15);
var dom_serializer_1 = __importDefault(__webpack_require__(21));
var domelementtype_1 = __webpack_require__(16);
/**
 ...
 */
var ElementType = __importStar(__webpack_require__(16));
var entities_1 = __webpack_require__(22);
/**
 ...
 */
var foreignNames_1 = __webpack_require__(25);
...
var decode_1 = __webpack_require__(23);
var encode_1 = __webpack_require__(24);
/**
...
var encode_2 = __webpack_require__(24);
...
var decode_2 = __webpack_require__(23);
...
var domhandler_1 = __webpack_require__(15);
var querying_1 = __webpack_require__(28);
var Checks = {
...
var stringify_1 = __webpack_require__(20);
var legacy_1 = __webpack_require__(29);
/**
...
let CssSyntaxError = __webpack_require__(37)
let Declaration = __webpack_require__(40)
let LazyResult = __webpack_require__(45)
let Container = __webpack_require__(54)
let Processor = __webpack_require__(67)
let stringify = __webpack_require__(44)
let fromJSON = __webpack_require__(69)
let Document = __webpack_require__(56)
let Warning = __webpack_require__(59)
let Comment = __webpack_require__(55)
let AtRule = __webpack_require__(63)
let Result = __webpack_require__(58)
let Input = __webpack_require__(50)
let parse = __webpack_require__(60)
let list = __webpack_require__(66)
let Rule = __webpack_require__(65)
let Root = __webpack_require__(64)
let Node = __webpack_require__(41)
...
let pico = __webpack_require__(38)

let terminalHighlight = __webpack_require__(39)
...
let { isClean, my } = __webpack_require__(42)
let CssSyntaxError = __webpack_require__(37)
let Stringifier = __webpack_require__(43)
let stringify = __webpack_require__(44)
...
let { isClean, my } = __webpack_require__(42)
let MapGenerator = __webpack_require__(46)
let stringify = __webpack_require__(44)
let Container = __webpack_require__(54)
let Document = __webpack_require__(56)
let warnOnce = __webpack_require__(57)
let Result = __webpack_require__(58)
let parse = __webpack_require__(60)
let Root = __webpack_require__(64)
...
let { SourceMapConsumer, SourceMapGenerator } = __webpack_require__(47)
let { dirname, resolve, relative, sep } = __webpack_require__(48)
let { pathToFileURL } = __webpack_require__(49)
...
let { SourceMapConsumer, SourceMapGenerator } = __webpack_require__(47)
let { fileURLToPath, pathToFileURL } = __webpack_require__(49)
let { resolve, isAbsolute } = __webpack_require__(48)
let { nanoid } = __webpack_require__(51)

let terminalHighlight = __webpack_require__(39)
let CssSyntaxError = __webpack_require__(37)
let PreviousMap = __webpack_require__(52)
...
let { SourceMapConsumer, SourceMapGenerator } = __webpack_require__(47)
let { existsSync, readFileSync } = __webpack_require__(53)
let { dirname, join } = __webpack_require__(48)
...
let Container = __webpack_require__(54)
let Parser = __webpack_require__(61)
let Input = __webpack_require__(50)
...
let Declaration = __webpack_require__(40)
let tokenizer = __webpack_require__(62)
let Comment = __webpack_require__(55)
let AtRule = __webpack_require__(63)
let Root = __webpack_require__(64)
let Rule = __webpack_require__(65)
...
let NoWorkResult = __webpack_require__(68)
let LazyResult = __webpack_require__(45)
let Document = __webpack_require__(56)
let Root = __webpack_require__(64)
...
let warnOnce = __webpack_require__(57)
let parse = __webpack_require__(60)
const Result = __webpack_require__(58)
...
/* harmony export */ });
/* harmony import */ var _html5_audio__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(72);
/* harmony import */ var _html5_video__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(73);
/* harmony import */ var _youtube__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(74);
...
function inputSetup(opts) {
  var input = new oTinput({
    ...
    onFileChange: function onFileChange(file) {
      currentFile = new File([file], "voskaudio", {
        type: file.type
      });
      opts.create(file);
...
!function () {
  ...
  function a(a) {
    var b = this;
    this._text = a.text || {}, this._onFileChange = a.onFileChange || function () {}, this._onFileError = a.onFileError || function () {}, this._onURLSubmit = a.onURLSubmit || function () {}, this._onURLError = a.onURLError || function () {}, this._dragover = a.onDragover || function () {}, this._dragleave = a.onDragleave || function () {}, this.element = this._setupElement(a.element), this._setupMouseEvents(), $(this.element).find('input[type="file"]').change(function () {
      b._reactToFile(this);
    }), $(this.element).find(".ext-input-field input").on("submit", function () {
      b._reactToURL($(this).val());
    }).keypress(function (a) {
      return 13 === a.which ? (b._reactToURL($(this).val()), !1) : void 0;
    });
  }

  a.prototype.getSupportedFormats = function () {
    var b = ["mp3", "ogg", "webm", "wav"],
        c = ["mp4", "ogg", "webm"],
        d = this.isFormatSupported || a.isFormatSupported,
        e = $.map(b, function (a, b) {
      return d(a) ? a : void 0;
    }),
    ...
    if ("string" != typeof a) {
      ...
      return b = document.createElement(c), !(!b.canPlayType || !b.canPlayType(a.type).replace(/no/, ""));
    }

    return b = document.createElement("audio"), !(!b.canPlayType || !b.canPlayType("audio/" + a + ";").replace(/no/, ""));
  }, a.getSupportedFormats = a.prototype.getSupportedFormats, a.isFormatSupported = a.prototype.isFormatSupported, a.prototype.parseYoutubeURL = function (a) {
    if (a.match) {
    ...
    return !1;
  }, a.parseYoutubeURL = a.prototype.parseYoutubeURL, window.oTinput = a, a.prototype._setupElement = function (a) {
    if ("undefined" == typeof a) throw "must specify container element";
    var b = this._text.button || "Choose audio (or video) file",
        c = '<button class="btn-file-input" style="width: 100%;">' + b + "</button>",
        d = ["position: absolute", "top: 0", "left: 0", "opacity: 0", "width: 100%"].join(";"),
        e = '<input type="file" accept="audio/*, video/*" style="' + d + '">',
        f = "position: relative; overflow: hidden;",
        g = '<div class="file-input-wrapper" style="' + f + '">' + c + e + "</div>",
        h = this._text.altButton || "Enter file URL",
        i = '<button class="alt-input-button">' + h + "</button>",
        j = this._text.altInputText || "Enter URL of audio or video file, or YouTube video:",
        k = this._text.closeAlt || "close",
        l = '<div class="ext-input-field" style="display: none;"><div class="close-ext-input">' + k + "</div><label>" + j + '<input type="text"></label><div class="ext-input-warning"></div></div>';
    return $(a).html(g + i + l), $(a)[0];
  }, a.prototype._setupMouseEvents = function () {
    var a = this,
        b = this.element,
        c = $(b).find(".file-input-wrapper")[0];
    c.addEventListener("dragover", function () {
      a._dragover();
    }, !1), c.addEventListener("dragleave", function () {
      a._dragleave();
    }, !1), $(b).find(".alt-input-button").click(function () {
      a.showURLInput();
    }), $(b).find(".close-ext-input").click(function () {
      a.showFileInput();
    });
  }, a.prototype._reactToFile = function (a) {
    var b = a.files[0];
    if (this.isFormatSupported(b)) this._onFileChange(b);else {
      var c = new Error("Filetype " + b.type + " not supported by this browser");

      this._onFileError(c, b);
    }
  }, a.prototype._reactToURL = function (a) {
    var b = a.replace(/\s/g, "");
    if (this.parseYoutubeURL(b)) return this._onURLSubmit(b);
    var c = b.split("."),
        d = c[c.length - 1];
    if (this.isFormatSupported(d)) this._onURLSubmit(b);else {
      var e = new Error("Filetype " + d + " not supported by this browser");

      this._onURLError(e, a);
    }
  }, a.prototype.showURLInput = function () {
    $(this.element).find(".ext-input-field").show().find("input").focus(), $(this.element).addClass("ext-input-active");
  }, a.prototype.showFileInput = function () {
    $(this.element).find(".ext-input-field").hide(), $(this.element).removeClass("ext-input-active");
  };
}();
...
(function () {
  ...
  var localStorageManager = {
    ...
    setItem: function setItem(key, value) {
      ...
      try {
        localStorage.setItem(this.identifier + '_' + key, JSON.stringify(valueWithMetadata));
        this.full = false;
      } catch (err) {
        var error = err.name; // Possible error names:
      ...
      if (this.full) {
        if (!this._lastRanOnFull && this.onFull && !(now - this._lastRanOnFull < 1000)) {
          this.onFull();
    ...
    getItem: function getItem(key, prefix) {
    ...
    getItemMetadata: function getItemMetadata(key, prefix) {
      if (prefix === undefined) {
    ...
    getArray: function getArray(opts) {
      opts = opts || {};
      opts.format = 'array';
    ...
    clearOldest: function clearOldest(callback) {
      ...
      try {
        localStorage.setItem(testKey, 'A'); // assumes test passes...
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ oldBrowserCheck)
/* harmony export */ });
/******************************************
                Other
******************************************/
  ...
  _createClass(Settings, [{
    ...
    value: function render() {
      ...
      return (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("div", null, (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("h2", {
        "class": "panel-title"
      }, "Settings"), (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)(_KeyboardShortcuts_jsx__WEBPACK_IMPORTED_MODULE_1__["default"], {
...
/* harmony export */ });
/* harmony import */ var _html_export_panel_ms__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(100);
...
/* harmony import */ var _export_formats_google_drive__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(101);
/* harmony import */ var _player_player__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(71);
/* harmony import */ var _clean_html__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5);
var $ = __webpack_require__(3);

var Mustache = __webpack_require__(91);

var toMarkdown = __webpack_require__(92);
...
exportFormats.download.push({
  ...
  fn: function fn(txt) {
    ...
    var player = (0,_player_player__WEBPACK_IMPORTED_MODULE_2__.getPlayer)();

    if (player) {
      result.media = player.getName();
      result['media-time'] = player.getTime(); // if (oT.media.ytEl) {
...
exportFormats.send.push({
  ...
  setup: function setup(cb) {
    this.checkGoogleAuth = (0,_export_formats_google_drive__WEBPACK_IMPORTED_MODULE_1__["default"])(cb);
  },
  fn: function fn(opts) {
...
var toMarkdown
var converters
var mdConverters = __webpack_require__(93)
var gfmConverters = __webpack_require__(94)
var HtmlParser = __webpack_require__(95)
var collapse = __webpack_require__(97)
...
function createHtmlParser () {
  ...
  if (typeof document === 'undefined') {
    var jsdom = __webpack_require__(96)
...
var voidElements = __webpack_require__(98);
Object.keys(voidElements).forEach(function (name) {
  voidElements[name.toUpperCase()] = 1;
});

var blockElements = {};
(__webpack_require__(99).forEach)(function (name) {
